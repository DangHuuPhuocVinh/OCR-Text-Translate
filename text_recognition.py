...
images = [
    keras_ocr.tools.read(url) for url in [
        'https://th.bing.com/th/id/R790d7ee45d0061786279ba972af4c124?rik=CBpS%2bGKAj4Z%2fuw&pid=ImgRaw',
        'https://i.pinimg.com/originals/9e/4b/86/9e4b869d04b58558b6e0384787192cf8.jpg',
        'https://th.bing.com/th/id/R7a289d0fcc0c00aa710cc4808e6a2c12?rik=u7fKewcaLAPx9w&pid=ImgRaw'
    ]
]
...
#   arr.append(prediction_groups[0][i][0])
# print(" ".join(arr))
# image_text = " ".join(arr)
